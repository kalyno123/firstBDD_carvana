@Regression
Feature: Carvana Main Functionality
  ...
  #Scenario Outline: Validate CAR FINDER menu item
  #  When user clicks on "CAR FINDER" menu item
  #  Then user should be navigated to "<url>"
  #  And user should see "<text>" text
  #  And user should see "<text>" text
  #  And user should see "TRY CAR FINDER" link
  #  When user clicks on "TRY CAR FINDER" link
  #  Then user should be navigated to "<url>"
  ...
  #  Examples:
  #    | text                                                                              | url                                       |
  #    | WHAT CAR SHOULD I GET?                                                            | https://www.carvana.com/help-me-search/   |
  #    | Car Finder can help! Answer a few quick questions to find the right car for you." | https://www.carvana.com/help-me-search/qa |
  #    | "WHAT IS MOST IMPORTANT TO YOU IN YOUR NEXT CAR?"                                 |                                           |
  #    | "Select up to 4 in order of importance"                                           |                                           |
  ...
  # Configure pom.xml with surefire plugin to be able to run all scenarios with
  # @Regression tag and mvn test -Dcucumber.options="—tags @Regression" command